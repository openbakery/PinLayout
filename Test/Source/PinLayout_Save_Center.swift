...
@available(iOS 11, *)
class PinLayout_Save_Center: PinLayout_Base_Test {
	...
	func test_saveArea_center() {
		...
		let constraints = pinLayout.saveAreaCenter(view: view)
	...
	func test_saveArea_center_to_other() {
		...
		let constraints = pinLayout.saveAreaCenter(view: view, with: other)
